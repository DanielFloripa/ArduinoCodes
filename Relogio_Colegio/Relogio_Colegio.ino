...
void mon_help(void){
  ...
  Serial.println("i Ler e mostrat data e tempo atual");
  Serial.println("s <d> <t> configura data <d> e/ou tempo <t>");
...
void mon_info(void){
  char wd[7][3] = { "Dom", "Seg", "Ter", "Qua", "Qui", "Ter", "Sab" };
  RTC.getTime();
